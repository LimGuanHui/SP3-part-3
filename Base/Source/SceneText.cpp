...
void SceneText::MissileUpdate(float dt)
{
    for (std::vector<Missile *>::iterator it = MissileList.begin(); it != MissileList.end(); ++it)
    {
        Missile *go = (Missile *)*it;
...
void SceneText::GameStateRenderText()
{
...
void SceneText::GameStateUpdate()
{
    switch (State)
    {
    case SceneText::Menu:
...
void SceneText::GameStateRender()
{
